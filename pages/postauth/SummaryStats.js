        ...
        <div className='-mx-3'>
            <dl className="mt-5 grid grid-cols-2 gap-5 lg:grid-cols-3">
                <div className="overflow-hidden rounded-lg bg-white px-3 lg:px-4 py-3 lg:py-5 shadow">
                    ...
                    <dd className="mt-1 text-xl lg:text-3xl font-semibold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-400 inline-block">{formatter.format(
                ...
                <div className="overflow-hidden rounded-lg bg-white px-3 lg:px-4 py-3 lg:py-5 shadow">
                    ...
                    <dd className="mt-1 text-xl lg:text-3xl font-semibold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-400 inline-block">{props.lastCheckIn}</dd>
                </div>
                <div className="overflow-hidden rounded-lg bg-white px-3 lg:px-4 py-3 lg:py-5 shadow">
                    <dt className="truncate text-sm font-medium text-slate-500">Goals</dt>
                    <dd className="mt-1 text-xl lg:text-3xl font-semibold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-green-400 inline-block">{props.numGoals}</dd>
                </div>
