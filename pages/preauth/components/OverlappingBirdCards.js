...
const birds = [
    ...
    {mt: 'mt-12', rarity: 'Common', name: 'North American Blackbird', date: 'Dec 2022', description: 'These blackbirds always lay two eggs, nurturing both birds'}, 
    {mt: 'mt-24', rarity: 'Common', name: 'Bald eagle', date: 'Aug 2022', description: 'Bald eagles wait around for the salmon run in Alaska before flying south'}, 
]
